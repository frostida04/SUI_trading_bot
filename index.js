...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            bot.use((0, conversations_1.createConversation)(controllers_1.help.helpConversation, "help"));
            bot.callbackQuery("help", controllers_1.help.help);
            bot.use((0, conversations_1.createConversation)(controllers_1.setting.settingConversation, "setting"));
            bot.callbackQuery("setting", controllers_1.setting.setting);
            // refer callback
            bot.callbackQuery("refer", controllers_1.refer.start);
            // claim callback
            bot.use((0, conversations_1.createConversation)(controllers_1.claim.claimConversation, "claim"));
            bot.callbackQuery("claim", controllers_1.claim.claim);
